...
import './containers/Title404';
import './containers/Parag404';
...
MapTo('page404/components/download')(DownloadV1, {isEmpty: DownloadV1IsEmptyFn});
MapTo('page404/components/list')(ListV2, {isEmpty: ListV2IsEmptyFn});
MapTo('page404/components/separator')(SeparatorV1, {isEmpty: SeparatorV1IsEmptyFn});
...
MapTo('page404/components/breadcrumb')(BreadCrumbV2, {isEmpty: BreadCrumbV2IsEmptyFn});
...
MapTo('page404/components/accordion')(AccordionV1, {isEmpty: AccordionV1IsEmptyFn});
MapTo('page404/components/carousel')(CarouselV1, {isEmpty: CarouselV1IsEmptyFn});
MapTo('page404/components/container')(ContainerV1, {isEmpty: ContainerV1IsEmptyFn});
